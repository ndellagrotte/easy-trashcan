package denizen.easytrashcan.datagen;

import denizen.easytrashcan.block.DecorationsBlocks;
import denizen.easytrashcan.item.DecorationsDataComponents;
import denizen.easytrashcan.item.DecorationsItemTags;
import denizen.easytrashcan.item.DecorationsItems;
import denizen.easytrashcan.item.StatueItem;
import denizen.easytrashcan.recipe.CanvasTransformRecipe;
import denizen.easytrashcan.recipe.CloneCanvasCraftingRecipe;
import denizen.easytrashcan.recipe.ColorWindChimeRecipe;
import denizen.easytrashcan.recipe.ComponentApplyCraftingRecipe;
...
import static denizen.easytrashcan.util.DecorationsUtil.getValues;
