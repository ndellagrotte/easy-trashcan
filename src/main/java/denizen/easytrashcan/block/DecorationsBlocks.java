...
import denizen.easytrashcan.block.extension.AttachedSignPostBlock;
import denizen.easytrashcan.block.extension.WallAttachedLanternBlock;
import denizen.easytrashcan.block.extension.WallAttachedOxidizableLanternBlock;
import denizen.easytrashcan.block.furniture.*;
import denizen.easytrashcan.block.item.*;
import denizen.easytrashcan.block.other.GhostLightBlock;
import denizen.easytrashcan.block.other.RopeBlock;
import denizen.easytrashcan.util.DecorationsSoundEvents;
